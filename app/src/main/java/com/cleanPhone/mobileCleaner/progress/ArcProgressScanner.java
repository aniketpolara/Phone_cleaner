...
public class ArcProgressScanner extends View {
    ...
    public ArcProgressScanner(Context context) {
        this(context, null);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(text, (getWidth() - this.textPaint.measureText(text)) / 2.0f, height, this.textPaint);
            this.textPaint.setTextSize((ParentActivity.displaymetrics.heightPixels * this.suffixTextSize) / 100.0f);
            canvas.drawText(this.suffixText, (getWidth() / 2.0f) + this.textPaint.measureText(text) + this.suffixTextPadding, (height + descent) - (this.textPaint.descent() + this.textPaint.ascent()), this.textPaint);
        ...
        canvas.drawText(getBottomText(), (getWidth() - this.textPaint.measureText(getBottomText())) / 2.0f, height2 - 100.0f, this.textPaint);
    }
    ...
    public ArcProgressScanner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ArcProgressScanner(Context context, AttributeSet attributeSet, int i) {
