...
public class DOCFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (arrayList2.size() == 0) {
            ...
            textView.setText(this.socialApp.get(this.mediaApp).mediaJunkData.get(3).totSelectedCount + " / " + this.dataList.size());
            ...
            checkBox.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TextView textView2 = DOCFragment.this.tvCount;
                    textView2.setText(((AppJunk) DOCFragment.this.socialApp.get(DOCFragment.this.mediaApp)).mediaJunkData.get(3).totSelectedCount + " / " + DOCFragment.this.dataList.size());
                    ((TextView) DOCFragment.this.getActivity().findViewById(R.id.clean_now_text)).setText("" + DOCFragment.this.getActivity().getString(R.string.mbc_clean) + " " + Util.convertBytes(((AppJunk) DOCFragment.this.socialApp.get(DOCFragment.this.mediaApp)).selectedSize));
                }
            });
